...
Cloud Project is a free and open-sourced Bootstrap themed Angular 9 starter project.
...
Cloud Project comes with a base implementation of navigation and layouts.
...
Cloud Project come with a production ready Dockerfile and build scripts.
